...
public class MainActivity extends BaseActivity implements ListView.OnTouchListener, OnItemClickListener, OnClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(!isOnline()){
			...
			// get images
			new WebRequest(1, this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "getImages");

			// get music
			new WebRequest(2, this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "getMusic");

			// get videos
			new WebRequest(3, this).executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, "getVideos"); 
